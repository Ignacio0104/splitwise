...
export default function ReportIcon(props: ReportIconProps) {
  ...
  const getIcon = () => {
    switch (props.type) {
      case 'household':
        return <Feather style={{ margin: 'auto' }} name="home" size={45} color="#277da1" />;
      case 'dinner':
        return <Ionicons name="fast-food-outline" size={45} color="#b5179e" />;
      case 'trip':
        return <MaterialCommunityIcons name="palm-tree" size={45} color="#80ed99" />;
      case 'party':
        return <MaterialCommunityIcons name="party-popper" size={45} color="#ee4266" />;
      case 'shopping':
        return <FontAwesome name="shopping-basket" size={40} color="#9d4edd" />;
      default:
        return <MaterialIcons style={{ paddingLeft: 2 }} name="attach-money" size={45} color="#006466" />;
    }
  };
